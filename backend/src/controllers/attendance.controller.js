...
module.exports = { checkIn, checkOut, myAttendance, getAllAttendance };

/**
 * CEO: view all employees' attendance, optionally filtered by ?userId=
 * and/or ?from= / ?to= date strings (YYYY-MM-DD).
 */
